...
export class BitrunnerServerExtension extends ServerExtension {
  ...
  constructor(serverName : string) {
    ...
    this.maxHealth = minValue(metadata.networkLayer) * minValue(metadata.maxRamExponent) * BitrunnerConstants.healthMult;
    this.health = this.maxHealth;
    this.target = "home";
    this.maxCooldown =  minValue(metadata.requiredHackingSkill) * BitrunnerConstants.cooldownMult + BitrunnerConstants.cooldownBase;
